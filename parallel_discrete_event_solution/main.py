...
if __name__ == "__main__":
    base_config = SimulationConfiguration(
        ...
        num_servers_c=2,  # Will be overridden
        C=2,  # Will be overridden
        K=5,  # Will be overridden
        num_simulations=100,
    ...
    configs = create_config_grid_ck(base_config, c_values, k_values)
    ...
    if successful > 0:
        print("\nSample Results:")
        for config, result in results[:3]:
